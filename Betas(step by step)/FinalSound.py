...
#Bg music
pygame.mixer.music.load(r'C:\Users\Evrika\.vscode\music.ogg')
...
while running:
    ...
    if player.health <= 0 or Pc.health <= 0:
            game_over = True
...
if show_start_screen():
    show_game_screen()  # Only start game if Start button was pressed
pygame.quit()
